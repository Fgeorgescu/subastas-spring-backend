...
public class BiddingService {
   ...
   */
  private static final List<String> LIMITLESS_AUCTION_TYPES = Arrays.asList("ORO", "PLATINO");
  ...
  public Item processBid(BidRequest bid, int itemId, int userId) {
    ...
    } else if (!LIMITLESS_AUCTION_TYPES.contains(auction.getCategory().toUpperCase()) && // Pujas que estén en la lista (true) deberían no entrar, por eso el !.
